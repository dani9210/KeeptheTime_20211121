...
import com.example.keepthetime_202111211111.utils.ContextUtil
...
//        서버 주소 => https 적용주소 + 도메인

        private val  BASE_URL = "https://keepthetime.xyz"

//        Retrofit 형태의 변수 -> OkHttpClient 처럼 실제 호출 담당.
//        레트로핏 객체는 -> 프로젝트를 통틀어 하나의객체만 만들고 -> 여러화면에서 공유하자.
//        객체를 하나로만 유지하자 -> 싱글턴 패턴 사용. (코드 디자인 패턴)

        private var retrofit : Retrofit?  = null    // 처음에는 없다. -> 하남나 만들고 이 변수를 공유.

         fun  getRetrofit(context : Context) : Retrofit {

             if (retrofit == null)  {

//               통신을 담당객체 아직 없으면 -> 그댸만 새로 만들자.
